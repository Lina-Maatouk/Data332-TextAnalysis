...
ui <- fluidPage(
  ...
  fluidRow(
    column(
      2,
      selectInput("Company", "Choose Company", choices = unique(dataset$Company), multiple = TRUE),
      selectInput("Word", "Choose Word", choices = unique(dataset$word), multiple = TRUE)
    ),
