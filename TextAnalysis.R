...
ggplot(fearbyCompany, aes(word, n,fill = Company)) +
  ...
  labs(x = "Company", y = "Count", title = "Sentiment of Fear in Top 3 Companies with Fraud Alert Problems") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
ggplot(fearbyState, aes(word, n, fill = State)) +
  ...
  labs(x = "State", y = "Count", title = "Sentiment of Fear in Top 3 States with Fraud Alert Problems") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
